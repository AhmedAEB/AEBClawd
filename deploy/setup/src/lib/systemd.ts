...
export function generateServerService(config: WizardConfig): string {
  return `[Unit]
...
export function generateFrontendService(config: WizardConfig): string {
  return `[Unit]
...
export function generateBotService(config: WizardConfig): string {
  return `[Unit]
